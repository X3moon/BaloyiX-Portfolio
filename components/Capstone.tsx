        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          <div>
            ...
            <div className="flex flex-wrap items-center gap-x-6 gap-y-4 justify-center lg:justify-start">
              ...
              <a href={CAPSTONE_PROJECT.jobReadinessAppUrl} target="_blank" rel="noopener noreferrer" className="flex items-center font-semibold text-gray-600 dark:text-gray-300 hover:text-amber-500 dark:hover:text-amber-400 transition-colors duration-300">
